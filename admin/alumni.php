					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$alumni = $conn->query("SELECT a.*,c.course,Concat(a.firstname,' ',a.lastname,' ',a.middlename) as name from alumnus_bio a inner join courses c on c.id = a.course_id order by Concat(a.firstname,'', a.lastname,' ',a.middlename) asc");
