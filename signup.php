                                ...
                                <div class="col-md-12">
                                    <form action="" id="create_account">
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Firsr Name</label>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-5">
                                                <label for="" class="control-label">Currently working as </label>
    ...
    $.ajax({
        ...
        success:function(resp){
            if(resp == 1){
                ...
                $('#msg').html('<div class="alert alert-warning">Please verify your account. Check your email.</div>');
                end_load();
            } else if(resp == 3){
                $('#msg').html('<div class="alert alert-success">Account created! Please verify your email.</div>');
                end_load();
                setTimeout(function(){
